...
<br>
<br>
<div class="cuadro" style="background:gray;color:white;width:20%;padding:1%;borderstyle:1%;font-family: sansation">
<h3>Selecciona tu Viaje</h3>
<hr>
<form action="busqueda.php" method="post">
<input type="radio" name="tipo" value="idayregreso">Ida y Regreso
<input type="radio" name="tipo" value="ida">Ida<br>
<br>
Ciudad de Origen: <br><input type="text" name="origen"><br>
<br>
Ciudad de Destino: <br><input type="text" name="destino"><br>
<br>
<input type="submit">
</form>
</div>
...
<div class="cuadro1" style="background:gray;color:white;font-family: sansation;padding:1%">
<h1 style="text-align:center">NextFlight</h1>
<h3 style="text-align:center">La mejor forma de Viajar</h3>
</div>
</body>';
}
