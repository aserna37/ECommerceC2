...
= 0.7.4 = 
Release Date: Dec 14th, 2017
* improved: Railway Schedule Tables (RU only) now without datepicker, so your visitor goes directly to TUTU.ru to choose a date
* fixed: Hotels tables currency bug. Now it changes due to your settings.
* fixed: Hotel Selection Widgets fix with Top Hotels selection (renamed)
* fixed: Bug with WPML/Polylang compability
* fixed: A bunch of frontend improvements
